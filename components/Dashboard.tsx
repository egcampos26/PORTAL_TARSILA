    ...
    <div className="min-h-screen flex flex-col relative bg-slate-900 overflow-hidden font-sans">
      ...
      <main className={`flex-1 relative z-10 flex flex-col items-center p-4 ${(!activeApp && !isLoadingApp && !isSettingsOpen) ? 'justify-center' : 'justify-start'}`}>
        ...
        {!activeApp && !isLoadingApp && !isSettingsOpen && (
          <div className="w-full max-w-5xl mx-auto flex flex-col items-end gap-6 animate-fade-in px-4 md:px-12">
            <div className="flex flex-wrap justify-end gap-4 md:gap-8 w-full mb-2">
              {apps.map((app) => (
        ...
        {activeApp && (
          <div className="absolute inset-0 flex flex-col items-center animate-fade-in px-0 md:px-4">
            <div className="w-full h-full bg-white rounded-2xl md:rounded-[2rem] overflow-hidden shadow-2xl flex flex-col">
               <iframe
